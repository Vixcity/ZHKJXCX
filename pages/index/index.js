      ...
      success: function (res) {
        ...
        if (res.data.code == 200) {
          ...
          data.forEach((item, index) => {
            ...
            // 	console.log(getTimeDiff(getTimestamp(nowTime), getTimestamp(item.workshop_yield_at), 'hours'))
            // 	if (!smallThan24h) {
            // 		return
            // 	}
            // }
    ...
    wx.scanCode({
      ...
      success: (res) => {
        if (res.errMsg === "scanCode:ok") {
          if (
            res.result.slice(0, 43) ===
            "https://knit-m-beta.zwyknit.com/miniprogram"
          ) {
          ...
          if (
            ...
            res.path.slice(0, 29) === "pages/addWorkShop/addWorkShop"
          ) {
            wx.navigateTo({
              url: "/" + res.path,
            });
